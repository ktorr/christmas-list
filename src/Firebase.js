...
import { getFirestore, collection, addDoc, getDocs, onSnapshot, doc, updateDoc, deleteDoc, getDoc } from 'firebase/firestore';
...
export { db, collection, addDoc, getDocs, onSnapshot, doc, updateDoc, deleteDoc, getDoc };
